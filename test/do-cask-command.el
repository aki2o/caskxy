...
(expectations
  ...
  (expect (mock (caskxy--show-message "Not found '%s'. Do you not yet install cask?" "c:/hoge/.cask/cask-cli.el"))
    (stub caskxy--do-exec => nil)
    (setenv "EMACS" "emacs")
    (let ((caskxy/cask-cli-path "c:/hoge/.cask/cask-cli.el"))
      (caskxy/do-cask-command "upgrade")))
  (desc "do-cask-command other than exec command")
  (expect (mock (caskxy--run-shell-command "'emacs' -Q --script c\\:/hoge/.cask/cask-cli.el -- upgrade" nil))
    (stub caskxy--do-exec => nil)
  ...
  (expect (mock (caskxy--run-shell-command "'emacs' -Q --script c\\:/hoge/.cask/cask-cli.el -- upgrade" t))
    (stub caskxy--do-exec => nil)
    (stub file-exists-p => t)
    (setenv "EMACS" "emacs")
    (let ((caskxy/cask-cli-path "c:/hoge/.cask/cask-cli.el"))
